...
if __name__ == "__main__":
    ...
    semgrep_report_dir = [d.replace(CVE_REPO_DIR,SEMGREP_REPORT_DIR) for d in cve_dirs]
    ...
    progress_bar = tqdm(total=len(semgrep_report_dir), desc="Processing test cases")
