...
def run_lockbud_cmd(test_case:TestCase):
    ...
    if test_case.lockbud_checker == "all":
        run_cmd(test_case,CARGO_LOCKBUD_CMD_ALL,env_dict,output_file=test_case.lockbud_report,error_file=test_case.error_file)
    elif test_case.lockbud_checker == "panic":
        run_cmd(test_case,CARGO_LOCKBUD_CMD_PANIC,env_dict,output_file=test_case.lockbud_report,error_file=test_case.error_file)
