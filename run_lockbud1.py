...
def run_test(test_case:TestCase):
    ...
    env_dict["LD_LIBRARY_PATH"] = LOCKBUD1_RUSTC_LD_LIBRARY_PATH
    env_dict["RUSTUP_TOOLCHAIN"] = LOCKBUD1_RUSTC_VERSION
    env_dict["PATH"] = LOCKBUD1_PATH + ":" + env_dict["PATH"]
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        lockbud_report_path = os.path.dirname(os.path.dirname(cve_repo_path.replace(CVE_REPO_DIR,LOCKBUD1_REPORT_DIR)))
    ...
    output_file = "lockbud1_reports_state.csv"
