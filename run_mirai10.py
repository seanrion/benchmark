...
def run_test(test_case:TestCase):
    ...
    env_dict["LD_LIBRARY_PATH"] = MIRAI10_RUSTC_LD_LIBRARY_PATH
    env_dict["RUSTUP_TOOLCHAIN"] = MIRAI10_RUSTC_VERSION
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        mirai_report_path = os.path.dirname(os.path.dirname(cve_repo_path.replace(CVE_REPO_DIR,MIRAI10_REPORT_DIR)))
    ...
    output_file = "mirai10_reports_state.csv"
