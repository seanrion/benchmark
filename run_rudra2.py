...
def run_test(test_case:TestCase):
    ...
    env_dict["PATH"] = RUDRA2_PATH + ":" + env_dict["PATH"]
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        rudra_report_path = os.path.dirname(os.path.dirname(cve_repo_path.replace(CVE_REPO_DIR,RUDRA2_REPORT_DIR)))
    ...
    output_file = "rudra2_reports_state.csv"
