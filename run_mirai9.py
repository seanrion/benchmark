...
def run_test(test_case:TestCase):
    ...
    env_dict["LD_LIBRARY_PATH"] = MIRAI9_RUSTC_LD_LIBRARY_PATH
    env_dict["RUSTUP_TOOLCHAIN"] = MIRAI9_RUSTC_VERSION
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        mirai_report_path = os.path.dirname(os.path.dirname(cve_repo_path.replace(CVE_REPO_DIR,MIRAI9_REPORT_DIR)))
    ...
    output_file = "mirai9_reports_state.csv"
