...
def run_test(test_case:TestCase):
    ...
    env_dict["LD_LIBRARY_PATH"] = MIRAI2_RUSTC_LD_LIBRARY_PATH
    env_dict["RUSTUP_TOOLCHAIN"] = MIRAI2_RUSTC_VERSION
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        # if not row['cve_id']=="GHSA-8mj7-wxmc-f424, RUSTSEC-2022-0028":
        #     continue
        cmd_excute_paths = row['cmd_excute_path']
        cve_repo_path = row['cve_repo_path']
        mirai_report_path = os.path.dirname(os.path.dirname(cve_repo_path.replace(CVE_REPO_DIR,MIRAI2_REPORT_DIR)))
    ...
    output_file = "mirai2_reports_state.csv"
